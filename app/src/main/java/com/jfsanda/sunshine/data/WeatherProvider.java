...
public class WeatherProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case WEATHER: {
                ...
                builder.setTables(WeatherContract.WeatherEntry.TABLE_NAME);
                retCursor = builder.query(mOpenHelper.getReadableDatabase(),projection,
            ...
            case LOCATION: {
                SQLiteQueryBuilder builder = new SQLiteQueryBuilder();
                builder.setTables(WeatherContract.LocationEntry.TABLE_NAME);
                retCursor = builder.query(mOpenHelper.getReadableDatabase(),projection,
                        selection,selectionArgs,null,null,sortOrder);
                break;
            }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        int deletedRows = 0;
        //this make delete all rows return the number of rows deleted
